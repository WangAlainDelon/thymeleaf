...
(function () {
    ...
    Util.load_scripts(["../../../novnc/include/webutil.js", "../../../novnc/include/base64.js", "../../../novnc/include/websock.js", "../../../novnc/include/des.js",
                       ...
                       "../../../novnc/include/rfb.js", "../../../novnc/include/keysym.js", "../../../novnc/include/inflator.js"]);
        ...
        start: function(callback) {
          ...
          //  UI.initSetting('host', window.location.hostname);
           ...
           // UI.initSetting('path', 'websockify');
            ...
            var autoconnect = $D('autoconnect').value;
            if (autoconnect === 'true' || autoconnect == '1') {
				...
				$D('settingsButton').style.display = "none";
...
*/
		...
		sendCtrlAltFunction: function(n) {
            UI.rfb.sendCtrlAltFunction(n);
        },
